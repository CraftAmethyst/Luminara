...
class ConfigMigrationTest {
    ...
    void migratesPermissionForwardingAndRemovesUnsafeSections(String legacy, PermissionForwarding expected) throws Exception {
        ...
        for (String path : result.removedUnsafeSettings()) {
            assertTrue(root.getNode((Object[]) path.split("\\.")).isVirtual(), path);
        }
    }
