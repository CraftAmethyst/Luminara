...
public class ArclightI18nLogger extends ExtendedLoggerWrapper {
    ...
    public static Logger getLogger(String name) {
        ...
        return new ArclightI18nLogger(
            (ExtendedLogger) LogManager.getLogger(name)
        );
    }
    ...
    protected void logMessage(
        ...
        super.logMessage(
            ...
            level,
            marker,
            ArclightLocale.getInstance().get(message.toString()),
            t
        );
    }
    ...
    protected void logMessage(
        ...
        super.logMessage(
            ...
            level,
            marker,
            ArclightLocale.getInstance().get(message),
            t
        );
    }
