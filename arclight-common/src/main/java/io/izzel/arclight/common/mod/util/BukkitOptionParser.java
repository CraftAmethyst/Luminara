...
public class BukkitOptionParser extends OptionParser {
    ...
    public BukkitOptionParser() {
        ...
        acceptsAll(
            asList("W", "world-dir", "universe", "world-container"),
            "World container"
        )
            .withRequiredArg()
            .ofType(File.class)
        ...
        acceptsAll(
            asList("log-limit"),
            "Limits the maximum size of the log file (0 = unlimited)"
        )
            .withRequiredArg()
            .ofType(Integer.class)
            .defaultsTo(0)
        ...
        acceptsAll(
            asList("log-count"),
            "Specified how many log files to cycle through"
        )
            .withRequiredArg()
            .ofType(Integer.class)
            .defaultsTo(1)
        ...
        acceptsAll(
            asList("log-strip-color"),
            "Strips color codes from log file"
        );
        ...
        acceptsAll(
            asList("C", "commands-settings"),
            "File for command settings"
        )
            .withRequiredArg()
            .ofType(File.class)
        ...
        acceptsAll(
            asList("eraseCache"),
            "Whether to force cache erase during world upgrade"
        );
