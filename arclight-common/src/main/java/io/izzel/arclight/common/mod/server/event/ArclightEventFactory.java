...
public abstract class ArclightEventFactory {
    ...
    public static EntityRegainHealthEvent callEntityRegainHealthEvent(
        Entity entity,
        float amount,
    ...
    public static EntityResurrectEvent callEntityResurrectEvent(
    ...
    public static void callEntityDeathEvent(
        LivingEntity entity,
        ...
        EntityDeathEvent event = new EntityDeathEvent(
            craftLivingEntity,
            drops,
            ((LivingEntityBridge) entity).bridge$getExpReward()
        );
        callEvent(event);
        ((LivingEntityBridge) entity).bridge$setExpToDrop(
            event.getDroppedExp()
        );
    }

    public static EntityDeathEvent callEntityDeathEvent(
    ...
    public static EntityDropItemEvent callEntityDropItemEvent(
        org.bukkit.entity.Entity entity,
        org.bukkit.entity.Item drop
    ) {
