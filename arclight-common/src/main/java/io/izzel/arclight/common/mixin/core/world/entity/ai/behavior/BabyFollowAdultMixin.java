...
public abstract class BabyFollowAdultMixin {
     ...
     */
    @Overwrite
    public static OneShot<AgeableMob> create(
        UniformInt p_259321_,
        Function<LivingEntity, Float> p_259190_
    ) {
        return BehaviorBuilder.create(p_258331_ -> {
            return p_258331_
                ...
                .apply(p_258331_, (p_258317_, p_258318_, p_258319_) -> {
                            ...
                            if (
                                ...
                                EntityTargetLivingEntityEvent event =
                                    CraftEventFactory.callEntityTargetLivingEvent(
                                        p_258327_,
                                        ageablemob,
                                        EntityTargetEvent.TargetReason.FOLLOW_LEADER
                                    );
                                ...
                                WalkTarget walktarget = new WalkTarget(
                                    ...
                                    p_259190_.apply(p_258327_),
                                    p_259321_.getMinValue() - 1
                                );
                                p_258318_.set(
                                    new EntityTracker(ageablemob, true)
                                );
