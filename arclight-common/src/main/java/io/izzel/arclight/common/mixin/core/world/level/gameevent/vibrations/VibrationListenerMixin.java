...
public abstract class VibrationListenerMixin {
    ...
    public boolean handleGameEvent(
        ...
        if (vibrationsystem_a.getCurrentVibration() != null) {
            ...
            !vibrationsystem_d.isValidVibration(gameevent, gameevent_a)
        ) {
            return false;
        } else {
            Optional<Vec3> optional = vibrationsystem_d
                .getPositionSource()
                .getPosition(worldserver);
            ...
            if (optional.isEmpty()) {
                ...
                // CraftBukkit start
                boolean defaultCancel = !vibrationsystem_d.canReceiveVibration(
                    worldserver,
                    BlockPos.containing(vec3d),
                    gameevent,
                    gameevent_a
                );
