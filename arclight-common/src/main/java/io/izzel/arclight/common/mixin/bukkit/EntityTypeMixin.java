...
public class EntityTypeMixin implements EntityTypeBridge {
    ...
    private void setup() {
        if (this.spec.entityClass != null) {
            try {
                ...
                if (e instanceof LocalizedException) {
                    ...
                    ArclightMod.LOGGER.warn(
                        "registry.entity.error",
                        this,
                        this.spec.entityClass,
                        e
                    );
                }
            }
        ...
        this.factory = loc -> {
            if (loc != null && loc.getWorld() != null) {
                ...
                net.minecraft.world.entity.Entity entity = handleType.create(
                    world
                );
                if (entity != null) {
                    entity.absMoveTo(
    ...
    @Override
    public void bridge$setEntityFactory(
        Function<Location, ? extends net.minecraft.world.entity.Entity> function
    ) {
