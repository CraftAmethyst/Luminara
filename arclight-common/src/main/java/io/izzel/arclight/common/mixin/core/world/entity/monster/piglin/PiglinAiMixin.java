...
public abstract class PiglinAiMixin {
    ...
    protected static void pickUpItem(
        ...
        if (isLovedByPiglin(itemstack, piglinEntity)) {
            piglinEntity
                .getBrain()
                .eraseMemory(MemoryModuleType.TIME_TRYING_TO_REACH_ADMIRE_ITEM);
            ...
            boolean flag = !piglinEntity
                .equipItemIfPossible(itemstack)
    ...
    private static boolean arclight$customBarter(
        ItemStack stack,
        Piglin piglin
    ) {
    ...
    private static void arclight$barterEvent(
        Piglin piglin,
        List<ItemStack> items
    ) {
        ItemStack stack = piglin.getItemInHand(InteractionHand.OFF_HAND);
        PiglinBarterEvent event = CraftEventFactory.callPiglinBarterEvent(
            piglin,
    ...
    private static boolean arclight$customBanter2(
        ItemStack stack,
        Piglin piglin
    ) {
        return isBarterItem(stack, piglin);
    ...
    private static boolean arclight$customBanter3(
        ItemStack stack,
        Piglin piglin
    ) {
        return isBarterItem(stack, piglin);
    ...
    private static boolean arclight$customLove2(
        ItemStack stack,
        Piglin piglin
    ) {
        return isLovedByPiglin(stack, piglin);
