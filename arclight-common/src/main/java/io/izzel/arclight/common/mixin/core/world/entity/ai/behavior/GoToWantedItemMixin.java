        ...
        return BehaviorBuilder.create(p_258371_ -> {
            ...
            return p_258371_
                .group(
                    ...
                    p_258371_.registered(
                        MemoryModuleType.ITEM_PICKUP_COOLDOWN_TICKS
                    )
                )
                .apply(
                    p_258371_,
                    (p_258387_, p_258388_, p_258389_, p_258390_) -> {
                        return (p_258380_, p_258381_, p_258382_) -> {
                            ...
                            if (
                                ...
                                // CraftBukkit start
                                if (
                                    p_258381_ instanceof
                                        net.minecraft.world.entity.animal.allay.Allay
                                ) {
                                    var event =
                                        CraftEventFactory.callEntityTargetEvent(
                                            p_258381_,
                                            itementity,
                                ...
                                WalkTarget walktarget = new WalkTarget(
                                    new EntityTracker(itementity, false),
                                    p_260346_,
                                    0
                                );
                                p_258387_.set(
                                    new EntityTracker(itementity, true)
                                );
