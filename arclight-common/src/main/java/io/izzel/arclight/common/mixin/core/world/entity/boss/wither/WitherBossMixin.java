            ...
            for (int i = 1; i < 3; ++i) {
                if (this.tickCount >= this.nextHeadUpdate[i - 1]) {
                    ...
                    if (
                        ...
                        this.idleHeadUpdates[i3] =
                            this.idleHeadUpdates[i - 1] + 1;
                        if (j3 > 15) {
                            double d0 = Mth.nextDouble(
                                this.random,
                                this.getX() - 10.0D,
                                this.getX() + 10.0D
                            );
                            double d1 = Mth.nextDouble(
                                this.random,
                                this.getY() - 5.0D,
                                this.getY() + 5.0D
                            );
                            double d2 = Mth.nextDouble(
                                this.random,
                                this.getZ() - 10.0D,
                                this.getZ() + 10.0D
                            );
                    ...
                    if (l1 > 0) {
                        ...
                        if (
                            ...
                            this.nextHeadUpdate[i - 1] =
                                this.tickCount + 40 + this.random.nextInt(20);
                            this.idleHeadUpdates[i - 1] = 0;
                        } else {
                            if (
                        ...
                        if (!list.isEmpty()) {
                            LivingEntity livingentity1 = list.get(
