...
public class Metrics {
    ...
    /**
     * Creates a new Metrics instance for server implementation.
     *
     * @param serverVersion The version of the server.
     * @param serviceId     The id of the service. It can be found at <a
     *                      href="https://bstats.org/what-is-my-plugin-id">What is my plugin id?</a>
     * @param dataFolder    The data folder for bStats configuration.
     */
    public Metrics(String serverVersion, int serviceId, File dataFolder) {
        // Get the config file
        File bStatsFolder = new File(dataFolder, "bStats");
        ...
        boolean logResponseStatusText = config.getBoolean(
    ...
    private void appendServiceData(
            JsonObjectBuilder builder,
            String serverVersion
    ) {
        builder.appendField("pluginVersion", serverVersion);
    }
    ...
    private int getPlayerAmount() {
        try {
            ...
            Method onlinePlayersMethod = Class.forName("org.bukkit.Server").getMethod(
                    "getOnlinePlayers"
            );
    ...
    public static class MetricsBase {
        ...
        private void submitData() {
            ...
            JsonObjectBuilder.JsonObject[] chartData = customCharts
                    .stream()
                    .map(customChart ->
                            customChart.getRequestJsonObject(errorLogger, logErrors)
                    )
        ...
        private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
            ...
            if (logResponseStatusText) {
                infoLogger.accept(
                        "Sent data to bStats and received response: " + builder
                );
            }
        }
        ...
        private void checkRelocation() {
            ...
            if (
                ...
                // little "trick" ... :D
                final String defaultPackage = new String(new byte[]{
                        'o',
                        'r',
                        'g',
                        '.',
                ...
                // package names
                if (
                        MetricsBase.class.getPackage().getName().startsWith(defaultPackage) ||
    ...
    public static class DrilldownPie extends CustomChart {
        ...
        public JsonObjectBuilder.JsonObject getChartData() throws Exception {
            ...
            for (Map.Entry<
                    String,
                    Map<String, Integer>
                    > entryValues : map.entrySet()) {
                JsonObjectBuilder valueBuilder = new JsonObjectBuilder();
                boolean allSkipped = true;
                for (Map.Entry<String, Integer> valueEntry : map
                        .get(entryValues.getKey())
                        .entrySet()) {
    ...
    public static class SimpleBarChart extends CustomChart {
        ...
        protected JsonObjectBuilder.JsonObject getChartData() throws Exception {
            ...
            for (Map.Entry<String, Integer> entry : map.entrySet()) {
                valuesBuilder.appendField(entry.getKey(), new int[]{
                        entry.getValue(),
                });
            }
            return new JsonObjectBuilder()
