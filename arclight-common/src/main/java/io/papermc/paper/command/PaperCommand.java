...
public final class PaperCommand extends Command {
    ...
    private static final Map<String, PaperSubcommand> SUBCOMMANDS = createSubcommands();
    ...
    public PaperCommand(final String name) {
        ...
        permissions.addAll(SUBCOMMANDS.keySet().stream().map(s -> BASE_PERM + s).collect(Collectors.toList()));
    ...
    private static boolean testPermission(final CommandSender sender, final String permission) {
        ...
        sender.sendMessage("I'm sorry, but you do not have permission to perform this command. Please contact the server administrators if you believe that this is in error.");
        return false;
    }
