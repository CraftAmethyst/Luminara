...
public final class SingleThreadChunkRegionManager {
    ...
    private final Supplier<RegionSectionData> regionSectionDataSupplier;
    ...
    */
    ...
    private void addToRecalcQueue(final Region region) {
        this.needsRecalculation.add(region);
    }

    private void removeFromRecalcQueue(final Region region) {
    ...
    private void recalculateRegion(final Region region) {
    ...
    public static final class Region {
        ...
        private Region(final SingleThreadChunkRegionManager regionManager) {
        ...
        */
        ...
        private boolean addRegionSection(final RegionSection section) {
        ...
        private boolean removeRegionSection(final RegionSection section) {
